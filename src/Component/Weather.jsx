      ...
      <div className="h-[20rem] w-[23rem] bg-[url('/weather.jpg')] bg-cover rounded-2xl shadow-amber-50  lg:w-[55rem]">
        ...
        <div className='flex justify-center items-center flex-col'>
          <form onSubmit={weatherData} className='flex justify-center items-center'>
            <input onChange={(e) => setCity(e.target.value)} value={city} className='bg-blue-200/35 lg:w-[30rem] p-1 text-[1rem] text-amber-50 focus:outline-none' type="text" placeholder='Enter City' />
